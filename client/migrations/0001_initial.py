    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_tubeid', models.DecimalField(blank=True, decimal_places=3, max_digits=30, null=True, verbose_name='Tube ID value')),
                ...
                ('input_ferrulelength', models.DecimalField(blank=True, decimal_places=3, max_digits=30, null=True, verbose_name='ferrule length value')),
                ('ferrule_id', models.CharField(blank=True, choices=[('INCH', 'INCH'), ('MM', 'MM')], max_length=128, null=True, verbose_name='Ferrule ID unit')),
                ('input_ferruleid', models.DecimalField(blank=True, decimal_places=3, max_digits=30, null=True, verbose_name='Ferrule ID Value')),
                ...
                ('input_tubespacing', models.DecimalField(blank=True, decimal_places=3, max_digits=30, null=True, verbose_name='Tube Spacing or Pitch Value')),
                ...
                ('input_totaltube', models.DecimalField(blank=True, decimal_places=3, max_digits=30, null=True, verbose_name='Total Tube Length Value')),
                ...
                ('input_toptube', models.DecimalField(blank=True, decimal_places=3, max_digits=30, null=True, verbose_name='Top Tube Sheet Thickness Value')),
                ...
                ('input_bottomtube', models.DecimalField(blank=True, decimal_places=3, max_digits=30, null=True, verbose_name='Bottom Tube Sheet Thickness Value')),
                ...
                ('input_tubeprotude_top', models.DecimalField(blank=True, decimal_places=3, max_digits=30, null=True, verbose_name='Tube Protude Top Value')),
                ...
                ('input_tubeprotude_bottom', models.DecimalField(blank=True, decimal_places=3, max_digits=30, null=True, verbose_name='Tube Protude Out Of Bottom Tube Sheet Value')),
