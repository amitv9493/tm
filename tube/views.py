...
def search_clients(request):
    if request.method == "POST":
        ...
        return render(
            request, "search_clients.html", {"searched": searched, "clients": clients}
        )
    else:
        return render(
            request, "search_clients.html", {"searched": searched, "clients": clients}
...
def search_warehouse(request):
    if request.method == "POST":
        ...
        return render(
            request, "search_warehouse.html", {"searched": searched, "wares": wares}
        )
    else:
        return render(
            request, "search_warehouse.html", {"searched": searched, "wares": wares}
...
def search_plants(request):
    if request.method == "POST":
        ...
        return render(
            request, "search_plants.html", {"searched": searched, "plants": plants}
        )
...
def search_units(request):
    if request.method == "POST":
        ...
        return render(
            request, "search_units.html", {"searched": searched, "units": units}
        )
    else:
        return render(
            request, "search_units.html", {"searched": searched, "units": units}
...
def search_reactors(request):
    if request.method == "POST":
        ...
        return render(
            request,
            "search_reactors.html",
            {"searched": searched, "reactors": reactors},
        )
    else:
        return render(
            request,
...
def search_calstand(request):
    if request.method == "POST":
        ...
        return render(
            request,
            "search_calstand.html",
            {"searched": searched, "calstand": calstand},
        )
    else:
        return render(
            request,
...
def warehouse(request):
    if (
        request.POST.get("warehouse_name")
        and request.POST.get("warehouse_location")
        and request.POST.get("warehouse_contact")
        and request.POST.get("warehouse_email")
        and request.POST.get("warehouse_manager")
    ):
        app = Warehouse()
...
def plants(request):
    if (
        request.POST.get("plant_location")
        and request.POST.get("plant_contact")
        and request.POST.get("name_of_unit")
        and request.POST.get("chemical_being_manufactured_by_this_unit")
    ):
        app = Plant()
        ...
        app.name_of_unit.add(
            name_of_unit="unit3", chemical_being_manufactured_by_this_unit="benzne"
        )
        app.save()
...
def equipments(request):
    if (
        request.POST.get("equipment_name")
        and request.POST.get("abbreviation")
        and request.POST.get("alternate_name")
        and request.POST.get("serial_number")
        and request.POST.get("asset_number")
        and request.POST.get("pm_status")
        and request.POST.get("location_for_warehouse")
        and request.POST.get("location_for_storage")
        and request.POST.get("packaging")
        and request.POST.get("is_this_part_of_set")
        and request.POST.get("if_yes_how_many_in_a_set")
        and request.POST.get("is_it_an_assembly")
        and request.POST.get("allowed_to_add_sub_parts")
    ):
        app = Equipment()
...
def clients(request, pk=id):
    if request.method == "POST" and "add_client" in request.POST:
        if (
            request.POST.get("official_name")
            and request.POST.get("comman_name")
            and request.POST.get("alternate_name")
            and request.POST.get("parent_company")
            and request.POST.get("former_name")
            and request.POST.get("contact_person")
            and request.POST.get("contact_person_phone")
            and request.POST.get("contact_person_email")
        ):
            app = Client()
            ...
            app.save()
            p1 = Address(
                addressline1=request.POST.get("oaddressline1"),
                addressline2=request.POST.get("oaddressline2"),
                addressline3=request.POST.get("oaddressline3"),
                City=request.POST.get("oCity"),
                Country=request.POST.get("oCountry"),
                State=request.POST.get("oState"),
                Zipcode=request.POST.get("oZipcode"),
            )
            p1.save()
            ...
            p2 = Address(
                addressline1=request.POST.get("saddressline1"),
                addressline2=request.POST.get("saddressline2"),
                addressline3=request.POST.get("saddressline3"),
                City=request.POST.get("sCity"),
                Country=request.POST.get("sCountry"),
                State=request.POST.get("sState"),
                Zipcode=request.POST.get("sZipcode"),
            )
            p2.save()
            ...
            p3 = Address(
                addressline1=request.POST.get("paddressline1"),
                addressline2=request.POST.get("paddressline2"),
                addressline3=request.POST.get("paddressline3"),
                City=request.POST.get("pCity"),
                Country=request.POST.get("pCountry"),
                State=request.POST.get("pState"),
                Zipcode=request.POST.get("pZipcode"),
            )
            p3.save()
...
def projects(request):
    if request.method == "POST" and "add_project" in request.POST:
        if (
            ...
            and request.POST.get("chemical_name")
            and request.POST.get("unit_name")
            and request.POST.get("reactor_name")
            and request.POST.get("project_number")
            and request.POST.get("ttd_name")
            and request.POST.get("bdd_name")
            and request.POST.get("cal_stand_name")
            and request.POST.get("equipment_prep")
            and request.POST.get("equipment_ready")
            and request.POST.get("equipment_ship_client")
            and request.POST.get("equipment_delivery_client")
            and request.POST.get("project_start")
            and request.POST.get("project_end")
            and request.POST.get("equipment_return_tubemaster")
            and request.POST.get("equipment_delivery_tubemaster")
            and request.POST.get("scope_of_work")
            and request.POST.get("contract")
            and request.POST.get("if_subcontract_client_name")
        ):
            app = Project()
            ...
            app.equipment_delivery_client = request.POST.get(
                "equipment_delivery_client"
            )
            app.project_start = request.POST.get("project_start")
            app.project_end = request.POST.get("project_end")
            app.equipment_return_tubemaster = request.POST.get(
                "equipment_return_tubemaster"
            )
            app.equipment_delivery_tubemaster = request.POST.get(
...
def show(request, client_id):
    ...
    if request.method == "POST" and "add_unit" in request.POST:
        if (
            ...
            app5.chemical_being_manufactured_by_this_unit = request.POST.get(
    ...
    if request.method == "POST" and "add_reactor" in request.POST:
        if (
            request.POST.get("plant_id")
            and request.POST.get("unit_id")
            and request.POST.get("reactor_name")
            and request.POST.get("tube_id")
            and request.POST.get("input_tubeid")
            and request.POST.get("is_there_ferrule_insert_in_tube")
            and request.POST.get("ferrule_length")
            and request.POST.get("input_ferrulelength")
            and request.POST.get("ferrule_id")
            and request.POST.get("input_ferruleid")
            and request.POST.get("tube_material_of_raws")
            and request.POST.get("tube_material_of_thermo")
            and request.POST.get("tube_material_of_supports")
            and request.POST.get("tube_material_of_plugs")
            and request.POST.get("tube_material_of_coolent_tubes")
            and request.POST.get("any_projections_on_tube_sheet_describe")
            and request.POST.get("tube_sheet_material")
            and request.POST.get("dom_material")
            and request.POST.get("tube_spacing_or_pitch")
            and request.POST.get("input_tubespacing")
            and request.POST.get("total_tube_length")
            and request.POST.get("input_totaltube")
            and request.POST.get("top_tube_sheet_thickness")
            and request.POST.get("input_toptube")
            and request.POST.get("bottom_tube_sheet_thickness")
            and request.POST.get("input_bottomtube")
            and request.POST.get("tube_protude_out_of_top_tube_sheet")
            and request.POST.get("select_tube_protude_top")
            and request.POST.get("input_tubeprotude_top")
            and request.POST.get("tube_protude_out_of_bottom_tube_sheet")
            and request.POST.get("select_tube_protude_bottom")
            and request.POST.get("input_tubeprotude_bottom")
            and request.POST.get("top_dome_removable")
            and request.POST.get("top_inlet_accessible")
            and request.POST.get("top_inlet_impingment_plate")
        ):
            app4 = Reactor()
            ...
            app4.is_there_ferrule_insert_in_tube = request.POST.get(
            ...
            app4.tube_material_of_supports = request.POST.get(
                "tube_material_of_supports"
            )
            app4.tube_material_of_plugs = request.POST.get("tube_material_of_plugs")
            app4.tube_material_of_coolent_tubes = request.POST.get(
                "tube_material_of_coolent_tubes"
            )
            app4.any_projections_on_tube_sheet_describe = request.POST.get(
            ...
            app4.bottom_tube_sheet_thickness = request.POST.get(
                "bottom_tube_sheet_thickness"
            )
            app4.input_bottomtube = request.POST.get("input_bottomtube")
            app4.tube_protude_out_of_top_tube_sheet = request.POST.get(
            ...
            app4.tube_protude_out_of_bottom_tube_sheet = request.POST.get(
                "tube_protude_out_of_bottom_tube_sheet"
            )
            app4.select_tube_protude_bottom = request.POST.get(
            ...
            app4.top_inlet_impingment_plate = request.POST.get(
                "top_inlet_impingment_plate"
            )
            app4.tube_spacing_proof_document = request.FILES[
                "tube_spacing_proof_document"
            ]
            app4.reactor_tube_sheet_drawings = request.FILES[
                "reactor_tube_sheet_drawings"
            ]
            app4.reactor_elevation_view_drawings = request.FILES[
...
def showwarehouse(request, warehouse_id):
    if request.method == "POST" and "add_ttd" in request.POST:
        if (
            ...
            and request.POST.get("packaging")
            and request.POST.get("is_this_part_of_set")
            and ("if_yes_how_many_in_a_set")
            and request.POST.get("size")
            and request.POST.get("total_sets")
            and request.POST.get("orifice_in_each_set")
            and request.POST.get("storage_case")
            and request.POST.get("notes")
            and request.POST.get("range")
            and request.POST.get("quantity")
            and request.POST.get("size1")
            and request.POST.get("quantity_rack")
            and request.POST.get("tube_seal_rack")
        ):
            app4 = TTD()
            ...
            p1 = Supply_orifice(
                ...
                total_sets=request.POST.get("total_sets"),
                orifice_in_each_set=request.POST.get("orifice_in_each_set"),
                storage_case=request.POST.get("storage_case"),
            ...
            p2 = Pressure_sensor(
                range=request.POST.get("range"), quantity=request.POST.get("quantity")
            )
            p2.save()
            app4.pressure_sensor.add(p2)
            app4.save()

            p3 = TTD_tube_seal_rack(
                size=request.POST.get("size1"),
                qty_rack=request.POST.get("quantity_rack"),
                tube_seal_rack=request.POST.get("tube_seal_rack"),
            )
            p3.save()
    ...
    if request.method == "POST" and "add_bdd" in request.POST:
        if (
            request.POST.get("bdd_abbreviation")
            and request.POST.get("bdd_alternate_name")
            and request.POST.get("bdd_serial_number")
            and request.POST.get("bdd_asset_number")
            and request.POST.get("bdd_location_for_warehouse")
            and request.POST.get("bdd_location_for_storage")
            and request.POST.get("bdd_packaging")
            and request.POST.get("bdd_is_this_part_of_set")
            and request.POST.get("bdd_if_yes_how_many_in_a_set")
            and request.POST.get("size")
            and request.POST.get("quantity_rack")
            and request.POST.get("tube_seal_rack")
        ):
            ...
            app5.if_yes_how_many_in_a_set = request.POST.get(
                "bdd_if_yes_how_many_in_a_set"
            )

            app5.save()

            p1 = BDD_tube_seal_rack(
                size=request.POST.get("size"),
                qty_rack=request.POST.get("quantity_rack"),
                tube_seal_rack=request.POST.get("tube_seal_rack"),
            )
    ...
    if request.method == "POST" and "add_cal_stand" in request.POST:
        if (
            request.POST.get("cal_abbreviation")
            and request.POST.get("cal_alternate_name")
            and request.POST.get("cal_serial_number")
            and request.POST.get("cal_asset_number")
            and request.POST.get("cal_location_for_warehouse")
            and request.POST.get("cal_location_for_storage")
            and request.POST.get("cal_packaging")
            and request.POST.get("cal_is_this_part_of_set")
            and request.POST.get("cal_if_yes_how_many_in_a_set")
            and request.POST.get("cal_stand_size")
            and request.POST.get("size")
            and request.POST.get("total_sets")
            and request.POST.get("in_sets")
        ):
            ...
            app6.if_yes_how_many_in_a_set = request.POST.get(
                "cal_if_yes_how_many_in_a_set"
            )
            app6.cal_stand_size = request.POST.get("cal_stand_size")

            app6.save()

            p1 = Calibration_orifice(
                size=request.POST.get("size"),
                total_sets=request.POST.get("total_sets"),
                in_sets=request.POST.get("in_sets"),
            )
            p1.save()
...
def updateunitrecord(request, id):
    ...
    chemical_being_manufactured_by_this_unit = request.POST[
        "chemical_being_manufactured_by_this_unit"
    ]
    ...
    member.chemical_being_manufactured_by_this_unit = (
        chemical_being_manufactured_by_this_unit
    )
...
def updatereactorrecord(request, id):
    ...
    tube_protude_out_of_top_tube_sheet = request.POST[
        "tube_protude_out_of_top_tube_sheet"
    ]
    ...
    any_projections_on_tube_sheet_describe = request.POST[
        "any_projections_on_tube_sheet_describe"
    ]
    ...
    reactor_elevation_view_drawings = request.FILES.get(
        "reactor_elevation_view_drawings"
    )
    ...
    member.any_projections_on_tube_sheet_describe = (
        any_projections_on_tube_sheet_describe
    )
